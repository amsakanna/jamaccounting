...
export class AccountPageComponent implements OnInit
{
	...
	private select( account: Account )
	{
		...
		const accountKey = this.accountService.selectedItem.key;
		this.eventManager.emitPageRequestEvent( Pages.Account, EventStatus.Requested, [ { key: 'account', value: accountKey } ] );
	}

	private newItem()
	{
		this.eventManager.emitPageRequestEvent( Pages.NewAccount, EventStatus.Requested );
	}
