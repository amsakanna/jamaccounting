...
export class Navigator
{
	...
	private buildMap()
	{
		...
		this.map[Pages.NewCompany + Event.IFS + EventStatus.Requested] = '/user/companies/@new';
		...
		this.map[Pages.NewAccount + Event.IFS + EventStatus.Requested] = '/company/{company}/accounts/@new';
